...
const OUTCOME_CATEGORIES = [
  {
    ...
    outcomes: [
      { value: "won_closed", label: "Won — Closed" },
      { value: "won_expanded", label: "Won — Expanded" },
      { value: "won_renewal", label: "Won — Renewal" },
    ],
  },
  {
    label: "Lost",
    ...
    outcomes: [
      { value: "lost_competitor", label: "Lost — Concurrent" },
      { value: "lost_to_internal_build", label: "Lost — Build interne" },
      { value: "lost_budget", label: "Lost — Budget" },
      { value: "lost_timing", label: "Lost — Timing" },
      { value: "executive_veto", label: "Lost — Veto exécutif" },
      { value: "technical_disqualification", label: "Lost — Disqualification technique" },
      { value: "legal_security_block", label: "Lost — Blocage légal/sécurité" },
      { value: "procurement_block", label: "Lost — Blocage procurement" },
    ],
  },
  {
    label: "Stalled",
    ...
    outcomes: [
      ...
      { value: "ghost_deal", label: "Ghost Deal" },
